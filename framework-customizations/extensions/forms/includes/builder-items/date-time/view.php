...
wp_enqueue_style('date-timepicker-css', UMODEL_THEME_URI . '/framework-customizations/extensions/forms/includes/builder-items/date-time/static/css/bootstrap-datetimepicker.min.css', false, UMODEL_THEME_VERSION );
wp_enqueue_script('moment-with-locales', UMODEL_THEME_URI . '/framework-customizations/extensions/forms/includes/builder-items/date-time/static/js/moment-with-locales.min.js', array('jquery'), UMODEL_THEME_VERSION );
wp_enqueue_script('bootstrap-datetimepicker', UMODEL_THEME_URI . '/framework-customizations/extensions/forms/includes/builder-items/date-time/static/js/bootstrap-datetimepicker.min.js', array('jquery'), UMODEL_THEME_VERSION );
?>
