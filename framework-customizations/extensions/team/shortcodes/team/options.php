...
$options = array(
	...
	'show_excerpt'  => array(
		'type'         => 'switch',
		'value'        => '',
		'label'        => esc_html__( 'Show excerpt', 'umodel' ),
		'desc'         => esc_html__( 'Hide or show excerpt', 'umodel' ),
		'left-choice'  => array(
			'value' => 'hide-excerpt',
			'label' => esc_html__( 'No', 'umodel' ),
		),
	...
	'show_socials'  => array(
		'type'         => 'switch',
		'value'        => '',
		'label'        => esc_html__( 'Show socials', 'umodel' ),
		'desc'         => esc_html__( 'Hide or show socials icons', 'umodel' ),
		'left-choice'  => array(
			'value' => 'hide-socials',
			'label' => esc_html__( 'No', 'umodel' ),
		),
