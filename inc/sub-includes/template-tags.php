...
if ( ! function_exists( 'umodel_auto_taxonomy' ) ) :
	/**
	 * Return taxonomy of given type for given post_type.
	 */
	function umodel_auto_taxonomy( $args = array() ) {
		...
		$taxonomies = array_merge( $taxonomies, apply_filters( 'umodel_auto_taxonomy_list', array() ) );
...
if ( ! function_exists( 'umodel_tt_kses_list' ) ) :
	/**
	 * Return array of allowed tags for template tags functions.
	 */
	function umodel_tt_kses_list( $args = array() ) {

		if ( array_key_exists( 'kses_list', $args ) ) {
			$out = $args['kses_list'];
		} else {
			$out = function_exists( 'umodel_kses_list' ) ? umodel_kses_list() : 'post';
			$out = apply_filters( 'umodel_tt_kses_list', $out );
		}
...
if ( ! function_exists( 'umodel_get_the_excerpt' ) ) :
	/**
	 * Retrieve excerpt with custom length in characters or words and custom more link.
	 */
	function umodel_get_the_excerpt( $args = array() ) {
		...
		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_the_excerpt_defaults', array() ) );
		...
		if ( ! empty( $post ) ) {
			...
			if ( post_password_required( $post ) ) {
				...
				$out = esc_html__( 'There is no excerpt because this is a protected post.', 'umodel' );
			} else {
		...
		return apply_filters( 'umodel_get_the_excerpt', $out );
	}
endif;


if ( ! function_exists( 'umodel_the_excerpt' ) ) :
	/**
	 * Echo excerpt with custom length in characters or words and custom more link.
	 */
	function umodel_the_excerpt( $args = array() ) {

		echo wp_kses( umodel_get_the_excerpt( $args ), umodel_tt_kses_list( $args ) );
	}
endif;
...
if ( ! function_exists( 'umodel_get_term_choices' ) ) :
	/**
	 * Retrieve associative array of "term_id => term_name" pairs.
	 */
	function umodel_get_term_choices( $post_id, $taxonomy ) {
...
if ( ! function_exists( 'umodel_get_the_terms' ) ) :
	/**
	 * Retrieve formatted terms.
	 */
	function umodel_get_the_terms( $args = array() ) {
		...
		$defaults = array(
			...
			'items_separator' => '<span>' . esc_html_x(
					', ', 'Used between list items, there is a space after the comma.', 'umodel' ) . '</span>',
		...
		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_the_terms_defaults', array() ) );
		...
		return apply_filters( 'umodel_get_the_terms', $out );
	}
endif;


if ( ! function_exists( 'umodel_the_terms' ) ) :
	/**
	 * Echo formatted terms.
	 */
	function umodel_the_terms( $args = array() ) {

		echo wp_kses( umodel_get_the_terms( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_featured_term' ) ) :
	/**
	 * Retrieve featured term.
	 */
	function umodel_get_featured_term( $args = array() ) {

		if ( ! array_key_exists( 'max_items', $args ) ) {
			$args['max_items'] = 1;
		}

		return umodel_get_the_terms( $args );
	}
endif;


if ( ! function_exists( 'umodel_featured_term' ) ) :
	/**
	 * Echo featured term.
	 */
	function umodel_featured_term( $args = array() ) {

		echo wp_kses( umodel_get_featured_term( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_the_categories' ) ) :
	/**
	 * Retrieve formatted categories.
	 */
	function umodel_get_the_categories( $args = array() ) {

		if ( ! array_key_exists( 'taxonomy', $args ) ) {
			$args['taxonomy'] = 'category';

			if ( apply_filters( 'umodel_use_auto_taxonomy_for_template_tags', true ) ) {
				$args['taxonomy'] = umodel_auto_taxonomy( array( 'type' => 'category' ) );
			}
		}
...
if ( ! function_exists( 'umodel_the_categories' ) ) :
	/**
	 * Echo formatted categories.
	 */
	function umodel_the_categories( $args = array() ) {

		echo wp_kses( umodel_get_the_categories( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_featured_category' ) ) :
	/**
	 * Retrieve featured category.
	 */
	function umodel_get_featured_category( $args = array() ) {
		...
		return umodel_get_the_categories( $args );
	}
endif;


if ( ! function_exists( 'umodel_featured_category' ) ) :
	/**
	 * Echo featured category.
	 */
	function umodel_featured_category( $args = array() ) {

		echo wp_kses( umodel_get_featured_category( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_the_tags' ) ) :
	/**
	 * Retrieve formatted tags.
	 */
	function umodel_get_the_tags( $args = array() ) {

		if ( ! array_key_exists( 'taxonomy', $args ) ) {
			$args['taxonomy'] = 'post_tag';

			if ( apply_filters( 'umodel_use_auto_taxonomy_for_template_tags', true ) ) {
				$args['taxonomy'] = umodel_auto_taxonomy( array( 'type' => 'tag' ) );
			}
		}
...
if ( ! function_exists( 'umodel_the_tags' ) ) :
	/**
	 * Echo formatted tags.
	 */
	function umodel_the_tags( $args = array() ) {

		echo wp_kses( umodel_get_the_tags( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_featured_tag' ) ) :
	/**
	 * Retrieve featured tag.
	 */
	function umodel_get_featured_tag( $args = array() ) {
		...
		return umodel_get_the_tags( $args );
	}
endif;


if ( ! function_exists( 'umodel_featured_tag' ) ) :
	/**
	 * Echo featured tag.
	 */
	function umodel_featured_tag( $args = array() ) {

		echo wp_kses( umodel_get_featured_tag( $args ), umodel_tt_kses_list( $args ) );
	}
endif;
...
if ( ! function_exists( 'umodel_get_object_time' ) ) :
	/**
	 * Retrieve formatted object time.
	 */
	function umodel_get_object_time( $args = array() ) {
		...
		$defaults = array(
			...
			'days_ago'          => false,
			'days_ago_max_days' => - 1,
			'days_ago_text'     => esc_html__( 'days ago', 'umodel' ),
			'today'             => esc_html__( 'Today', 'umodel' ),
			'yesterday'         => esc_html__( 'Yesterday', 'umodel' ),
			'week_ago'          => esc_html__( 'Week ago', 'umodel' ),
			'weeks_ago'         => esc_html__( 'weeks ago', 'umodel' ),
			'month_ago'         => esc_html__( 'Month ago', 'umodel' ),
			'months_ago'        => esc_html__( 'months ago', 'umodel' ),
			'year_ago'          => esc_html__( 'Year ago', 'umodel' ),
			'years_ago'         => esc_html__( 'years ago', 'umodel' ),
		);

		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_object_time_defaults', array() ) );
		...
		return apply_filters( 'umodel_get_object_time', $out );
	}
endif;


if ( ! function_exists( 'umodel_get_the_date' ) ) :
	/**
	 * Retrieve formatted post date.
	 */
	function umodel_get_the_date( $args = array() ) {
		...
		return umodel_get_object_time( $args );
	}
endif;


if ( ! function_exists( 'umodel_the_date' ) ) :
	/**
	 * Echo formatted post date.
	 */
	function umodel_the_date( $args = array() ) {

		echo wp_kses( umodel_get_the_date( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_the_time' ) ) :
	/**
	 * Retrieve formatted post time.
	 */
	function umodel_get_the_time( $args = array() ) {
...
if ( ! function_exists( 'umodel_the_time' ) ) :
	/**
	 * Echo formatted post time.
	 */
	function umodel_the_time( $args = array() ) {

		echo wp_kses( umodel_get_the_time( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_comment_date' ) ) :
	/**
	 * Retrieve formatted comment date.
	 */
	function umodel_get_comment_date( $args = array() ) {
...
if ( ! function_exists( 'umodel_comment_date' ) ) :
	/**
	 * Echo formatted comment date.
	 */
	function umodel_comment_date( $args = array() ) {

		echo wp_kses( umodel_get_comment_date( $args ), umodel_tt_kses_list( $args ) );
	}
endif;


if ( ! function_exists( 'umodel_get_comment_time' ) ) :
	/**
	 * Retrieve formatted comment time.
	 */
	function umodel_get_comment_time( $args = array() ) {
...
if ( ! function_exists( 'umodel_comment_time' ) ) :
	/**
	 * Echo formatted comment time.
	 */
	function umodel_comment_time( $args = array() ) {

		echo wp_kses( umodel_get_comment_time( $args ), umodel_tt_kses_list( $args ) );
	}
endif;
...
if ( ! function_exists( 'umodel_get_comments_counter' ) ) :
	/**
	 * Retrieve formatted post comments counter.
	 */
	function umodel_get_comments_counter( $args = array() ) {
		...
		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_comments_counter_defaults', array() ) );
		...
		return apply_filters( 'umodel_get_comments_counter', $out );
	}
endif;


if ( ! function_exists( 'umodel_comments_counter' ) ) :
	/**
	 * Echo formatted post comments counter.
	 */
	function umodel_comments_counter( $args = array() ) {

		echo wp_kses( umodel_get_comments_counter( $args ), umodel_tt_kses_list( $args ) );
	}
endif;
...
if ( ! function_exists( 'umodel_get_the_author' ) ) :
	/**
	 * Retrieve formatted author vcard.
	 */
	function umodel_get_the_author( $args = array() ) {
		...
		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_the_author_defaults', array() ) );
		...
		return apply_filters( 'umodel_get_the_author', $out );
	}
endif;


if ( ! function_exists( 'umodel_the_author' ) ) :
	/**
	 * Echo formatted author vcard.
	 */
	function umodel_the_author( $args = array() ) {

		echo wp_kses( umodel_get_the_author( $args ), umodel_tt_kses_list( $args ) );
	}
endif;
...
if ( ! function_exists( 'umodel_get_sticky_marker' ) ) :
	/**
	 * Retrieve formatted sticky marker.
	 */
	function umodel_get_sticky_marker( $args = array() ) {
		...
		$defaults = array_merge( $defaults, apply_filters( 'umodel_get_sticky_marker_defaults', array() ) );
		...
		return apply_filters( 'umodel_get_sticky_marker', $out );
	}
endif;


if ( ! function_exists( 'umodel_sticky_marker' ) ) :
	/**
	 * Echo formatted sticky marker.
	 */
	function umodel_sticky_marker( $args = array() ) {

		echo wp_kses( umodel_get_sticky_marker( $args ), umodel_tt_kses_list( $args ) );
	}
endif;